...
void BitcoinGUI::createActions()
{
   ...
   // miningOffAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningOneAction->setStatusTip(tr("Mine DotCoin with 1 process. 1GB Required. Program may crash if insufficient memory is available."));
   // miningOneAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningTwoAction->setStatusTip(tr("Mine DotCoin with 2 processes. 1.75GB Required. Program may crash if insufficient memory is available."));
   // miningTwoAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningThreeAction->setStatusTip(tr("Mine DotCoin with 3 processes. 2.5GB Required. Program may crash if insufficient memory is available."));
   // miningThreeAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningFourAction->setStatusTip(tr("Mine DotCoin with 4 processes. 3.25GB Required. Program may crash if insufficient memory is available."));
...
void BitcoinGUI::setMining(double hashrate, int threads)
{
    ...
    else
    {
        ...
        labelMiningIcon->setToolTip(tr("Not mining DotCoin"));
    }
}
